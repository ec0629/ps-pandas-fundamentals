# -*- coding: utf-8 -*-
"""
Created on Fri Jan  8 13:57:26 2021
...
def get_record_from_file(file_path, keys_to_use):
    """Process single json file and return
    a tuple containing specific fields"""
...
# Simple file processing function demo
SAMPLE_JSON = os.path.join('.', 'artworks',
                           'a', '000',
                           'a00001-1035.json')
...
def read_artworks_from_json(keys_to_use):
    ...
    for first five in each directory call function 
